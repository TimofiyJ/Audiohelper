...
if __name__ == "__main__":
    ...
    class GenerateAnswer(dspy.Signature):
        ...
        You have to be gentle and nice. Don't answer personal information such as password"""
    ...
    autogen.register_function(
        ...
        description="Tool that helps get answers for personal predefined questions",
    )
